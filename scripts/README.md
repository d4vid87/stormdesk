...
ffmpeg -y -framerate 2 -i shots/marketing/frame-%03d.png -vf 'scale=960:-1:flags=lanczos,split[a][b];[a]palettegen=max_colors=128[p];[b][p]paletteuse=dither=bayer:bayer_scale=3' -loop 0 marketing/images/stormdesk-tour.gif
